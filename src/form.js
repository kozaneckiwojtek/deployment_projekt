    ...
    return (
        ...
        <div>
            ...
            <form id="form" onSubmit={onSubmit} ref={formRef} acceptCharset="UTF-8">
                ...
                <select name="text" class="wejscie" id="termin" aria-placeholder="" required="required" data-validation-required-message="Wybierz termin" >
                ...
                <select name="nocleg" class="wejscie" id="nocleg" aria-placeholder="" required="required" data-validation-required-message="Wybierz opcje" >
